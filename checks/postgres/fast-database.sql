...
--
-- Pass: fast, scope: database. 47 check(s), run in priority order so that if the run
...
-- ======== PG-IDX-018  P100  Unindexed foreign key on a write-active parent ========
\echo '@@CHECK PG-IDX-018'
-- check: PG-IDX-018
